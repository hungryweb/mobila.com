...
class MailTransport implements ITransport
{
     ...
     * @param \Tygh\Notifications\Transports\BaseMessageSchema $schema                     Event message schema
     *
     * @return string[]
     */
    protected function getReceivers(array $receiver_search_conditions, BaseMessageSchema $schema)
    {
        $emails = [];
